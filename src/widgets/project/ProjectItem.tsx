...
function ProjectItem({
  ...
  return (
    <div className="project-item p-6 border border-primary-200 flex flex-col gap-6 rounded-3xl h-80">
      ...
      <div className="team-lefttime flex items-center justify-between">
        ...
        <div className="left-time text-sm font-medium rounded-3xl border px-6 py-2 text-nowrap">
          {leftTime} left
        </div>
      </div>
    </div>
